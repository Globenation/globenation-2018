            ...
            if ( $tdbLoadDataFromId !== false && $tdbTemplateType !== false ) {
                switch ($tdbTemplateType) {
                    ...
                    case 'author':
                        ...
                        // get the author wp_query.. do the query with 'posts_per_page' and 'offset' params
                        $wp_query_content = new WP_Query( array(
                    ...
                    case 'search':
                        ...
                        // get the search wp_query.. do the query with 'posts_per_page' and 'offset' params
                        $wp_query_content = new WP_Query( array(
                                's' => $tdbLoadDataFromId,
                                'posts_per_page' => tdb_util::get_shortcode_att( $tem_content, 'tdb_loop','limit' ),
                                'offset' => tdb_util::get_shortcode_att( $tem_content, 'tdb_loop','offset' )
                    ...
                    case 'date':
                        ...
                        // get the date wp_query.. do the query with 'posts_per_page' and 'offset' params
                        $wp_query_content = new WP_Query( array(
                    ...
                    case 'tag':
                        ...
                        // get the tag wp_query.. do the query with 'posts_per_page' and 'offset' params
                        $wp_query_content = new WP_Query( array(
                                'tag' => $tag->slug,
                                'posts_per_page' => tdb_util::get_shortcode_att( $tem_content, 'tdb_loop','limit' ),
                                'offset' => tdb_util::get_shortcode_att( $tem_content, 'tdb_loop','offset' )
