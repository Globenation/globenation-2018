...
/**
 * Class tdb_search_title
 */

class tdb_search_title extends td_block {
    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
                ...
                /* @result_color_solid */
				.$unique_block_class .tdb-search-query {
					color: @result_color_solid;
				}
				/* @result_color_gradient */
				.$unique_block_class .tdb-search-query {
					@result_color_gradient
				...
				html[class*='ie'] .$unique_block_class .tdb-search-query,
				.td-md-is-ios .$unique_block_class .tdb-search-query {
				    background: none;
					color: @result_color_gradient_1;
				}
				/* @add_text_color_solid */
				.$unique_block_class .tdb-search-add-text {
				...
				.td-md-is-ios .$unique_block_class .tdb-search-add-text {
					-webkit-text-fill-color: initial;
				}
				html[class*='ie'] .$unique_block_class .tdb-search-add-text,
				.td-md-is-ios .$unique_block_class .tdb-search-add-text {
				    background: none;
					color: @add_text_color_gradient_1;
				}
				/* @style_bg */
				.$unique_block_class .tdb-single-search-text  {
					-webkit-text-fill-color: initial;
					background: @style_bg;
    ...
    static function cssMedia( $res_ctx ) {
        ...
        // title color
        $res_ctx->load_color_settings( 'result_color', 'result_color_solid', 'result_color_gradient', 'result_color_gradient_1', '' );
    ...
    function render( $atts, $content = null ) {
        ...
        $search_title_data = $tdb_state_search->title->__invoke( $atts );
        ...
        $buffy .= '<div class="' . $this->get_block_classes() . '" ' . $this->get_block_html_atts() . '>';
            ...
            $buffy .= '<div class="tdb-block-inner td-fix-index">';
                ...
                $buffy .= '<' . $title_tag . ' class="tdb-single-search-text"><span class="tdb-search-query">' . $search_title_data['title'] . '</span> <span class="tdb-search-add-text">' . $this->get_att('add_text') . '</span></' . $title_tag . '>';
