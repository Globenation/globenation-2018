...
clearTimeout(tdcCssEditor.timeoutIframeHtml);if(!a.isUndefined(tdcSidebar.currentViewportSettings.settings)){var c=d.find("label"),f=d.find("input"),p=d.find("output");c.html(tdcSidebar.currentViewportSettings.name);a.isUndefined(tdcSidebar.currentViewportSettings.settings.limitBottom)?f.attr("min",200):f.attr("min",tdcSidebar.currentViewportSettings.settings.limitBottom);f.attr("max",tdcSidebar.currentViewportSettings.settings.limitTop);f.attr("value",b);p.html(b+"px")}},100))},_updateData:function(a){var b=
a.data("model_id"),d=a.data("param_name"),e=a.closest(".tdc-tab-content");"undefined"===typeof b?tdcCssEditor.saveWidgetForm(a):(a=tdcIFrameData.getModel(b),e=tdcCssEditor._generateCssAttValue(e),tdcSidebarController.onUpdate(a,d,"",e))},saveWidgetForm:function(a){var b=a.closest("form");a=a.closest(".tdc-tab-content");if(b.length){var d=b.find('input[name="id_base"]').val(),e=b.find('input[name="widget-id"]').val().replace(d+"-","");d="'widget-"+d+"["+e+"][tdc_css]'";e=b.find("input[name="+d+"]");
var g=tdcCssEditor._generateCssAttValue(a);a.data("tdc_css",g);e.length?e.val(g):b.append('<input type="hidden" name='+d+' value="'+g+'">')}},addWidgetCssEditor:function(a,c){tdcCssEditor._mappedParameter=a;return tdcCssEditor._generateEditorContent(c)},addComposerCssEditor:function(a,c){tdcCssEditor._mappedParameter=a;tdcCssEditor._model=c;var b=c.get("attrs")[a.param_name];return tdcCssEditor._generateEditorContent(b)},_checkDefaultColor:function(b){var c=b.closest(".tdc-property-wrap").find(".tdc-colorpicker-wrap");
""===b.val()&&(b=b.data("default_value"),a.isUndefined(b)?c.attr("style",""):c.attr("style","background-color: "+tdcCssEditor._getRgba(b)))},_generateEditorContent:function(b){if(a.isEmpty(b))tdcCssEditor._currentCssSettings=d;else try{var c=JSON.parse(window.atob(b));tdcDebug.log(c);a.isObject(c)?tdcCssEditor._currentCssSettings=c:tdcCssEditor._currentCssSettings=d}catch(f){tdcCssEditor._currentCssSettings=d,new tdcNotice.notice(f.message,!1,!1)}tdcSidebarPanel._hook.addAction("panel_rendered",function(){h(".tdc-css-image-wrap").each(function(b,
c){var f=h(c),e=f.closest(".tdc-property-wrap"),n=e.find(".tdc-css-image-remove"),k=e.find(".tdc-inherit-image"),l={isInherited:!1},m=tdcCssEditor._getSettingsProperty("background-image",d,l);l.isInherited?e.addClass(tdcCssEditor._INHERITED_CSS_CLASS):e.removeClass(tdcCssEditor._INHERITED_CSS_CLASS);a.isUndefined(m)?(n.addClass("tdc-hidden-button"),k.hide()):("no_value"===m?n.addClass("tdc-hidden-button"):(n.removeClass("tdc-hidden-button"),f.attr("style",'background-image: url("'+m+'")')),"all"!==
tdcSidebar.currentViewportSettings.name&&k.show());f.data("image_link",m)});h(".tdc-inherit").each(function(b,c){var f=h(c),e=f.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))f.hide();else{var n=e.data("tdc-for");e={isInherited:!1};n=tdcCssEditor._getSettingsProperty(n,d,e);e.isInherited?f.hide():a.isUndefined(n)||f.show()}})});return tdcCssEditor.generateEditorResponsiveContent()},_cleanCss:function(b,c){if("undefined"===
typeof c)return d;if("no_value"===c)return c;if("background-image"===b){var f=/(url\s*\(\s*['"]?)(.*?)\s*(['"]?\s*\))/ig.exec(c);return a.isEmpty(f)?"":f[2]}c=c.toLowerCase();c=c.replace(/!important|px/g,"");return c.trim()},_getDataNoValue:function(a){var b="";"no_value"===a&&(b=' data-no_value="1" ');return b},callbackColorPicker:function(){h(".tdc-tab-design .tdc-property-colorpicker").each(function(){h("#tdc-palette-color-picker").tdPalette();var b=h(this),c=b.find("input"),d=b.closest(".tdc-property-wrap");
...
('<div class="tdc-clear-css-properties" '+tdcSidebarPanel._getParamterDataAtts(g,p)+' title="Clear all tab css settings">Clear CSS settings</div>');k+="</div>";tdcSidebarPanel._hook.addAction("panel_css",tdcCssEditor.callbackColorPicker);tdcSidebarPanel._hook.addAction("panel_css",function(){h(".tdc-inherit").each(function(b,c){var f=h(c),e=f.closest(".tdc-property-wrap");if("all"===tdcSidebar.currentViewportSettings.name||e.hasClass(tdcCssEditor._INHERITED_CSS_CLASS))f.hide();else{var g=e.data("tdc-for");
...
e+='<div class="tdc-responsive-tablet-portrait '+m+'" title="Portrait viewport"><span class="tdc-tablet-portrait-icon"></span></div>';e+='<div class="tdc-responsive-phone '+g+'" title="Phone viewport"><span class="tdc-phone-icon"></span></div>';e+="</div>";e+="</div>";e+='<div class="tdc-tab-content-wrap">';l=k=h="";for(f=0;f<c.length;f++){g=tdcSidebarPanel._fixGroupName(c[f]);m=tdcUtil.makeSafeForCSS(g);g="tdc-tab-no-design";var t=a.get("tag");"css"===m&&(g="tdc-tab-design");0===f?(h='<div class="tdc-tab-content tdc-tab-content-visible '+
g+'" id="td-tab-'+m+'">',k='<div class="tdc-tab-content '+g+'" id="td-tab-'+m+'">',m=window.tdcAdminSettings.mappedShortcodes[t].tdc_start_values,a.unset("presetValues"),_.isUndefined(m)||(m=JSON.parse(window.atob(m)),_.isArray(m)&&1<m.length&&a.set("presetValues",m)),a.has("presetValues")&&(m=a.get("presetValues"),l+=tdcSidebarPanel._addPresetValuesSelector(m,a))):_.isUndefined(p)||p!=="td-tab-"+m?l+='<div class="tdc-tab-content '+g+'" id="td-tab-'+m+'">':(h=k,l+='<div class="tdc-tab-content tdc-tab-content-visible '+
g+'" id="td-tab-'+m+'">');l+=tdcSidebarPanel._bindGroupAndGetHtml(c[f],b,a);m=' data-model_id="'+a.cid+'" ';"vc_row"===a.attributes.tag?(l+='<div class="tdc-sidebar-row-buttons">',l+='<div class="tdc-sidebar-button tdc-sidebar-delete-row" '+m+' title="Delete the current selected Row">Delete Row</div>',l+='<div class="tdc-sidebar-button tdc-sidebar-clone-row" '+m+' title="Make a copy of the current selected Row. The copy will appear below the current Row">Clone Row</div>',"dev"===window.tdcAdminSettings.deployMode&&
(l+='<div class="tdc-sidebar-button tdc-sidebar-shortcode-row" '+m+' title="Get the shortcode of the current row">CONSOLE: shortcode</div>'),l+="</div>"):"vc_row_inner"===a.attributes.tag?(l+='<div class="tdc-sidebar-row-buttons">',l+='<div class="tdc-sidebar-button tdc-sidebar-delete-inner-row" '+m+' title="Delete the current selected Inner Row">Delete Inner Row</div>',l+='<div class="tdc-sidebar-button tdc-sidebar-clone-inner-row" '+m+' title="Make a copy of the current selected Inner Row. The copy will appear below the current Inner Row">Clone Inner Row</div>',
l+="</div>"):"vc_column"!==a.attributes.tag&&"vc_column_inner"!==a.attributes.tag&&(l+='<div class="tdc-sidebar-row-buttons">',"dev"===window.tdcAdminSettings.deployMode&&(l+='<div class="tdc-sidebar-button tdc-sidebar-current-styles-settings" '+m+' title="Get the current styles\' settings">CONSOLE: style presets</div>'),l+="</div>");l+="</div>"}e=e+(h+l)+"</div>";jQuery(".tdc-inspector .tdc-tabs-wrapper").html(e);jQuery(".tdc-inspector-wrap").addClass("tdc-inspector-active");tdcSidebarPanel._hook.addAction("panel_rendered",
...
tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&(window.tdcAdminSettings.tdcSavings={});"undefined"===typeof window.tdcAdminSettings.tdcSavings.recentFonts&&(window.tdcAdminSettings.tdcSavings.recentFonts=[]);var b=window.tdcAdminSettings.tdcSavings.recentFonts.indexOf(a);-1!==b&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(b,1);
window.tdcAdminSettings.tdcSavings.recentFonts.push(a);20<=window.tdcAdminSettings.tdcSavings.recentFonts.length&&window.tdcAdminSettings.tdcSavings.recentFonts.splice(0,1);tdcUtil.updateTdcSavings()})});jQuery(".tdc-breadcrumbs").show();tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");(function(){if("vc_row"===a.get("tag")){var b=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),d=a.get("childCollection");if(!_.isUndefined(d)){d=
...
b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":b.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),b.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})()}},_bindGroupAndGetHtml:function(a,d,b){for(var c="",f=b.get("attrs"),e=0;e<d.params.length;e++){var g=d.params[e].param_name,
p=d.params[e].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(d.params[e].group)||d.params[e].group===a)c+=tdcSidebarPanel._bindParamAndGetHtml(d.params[e],b);if("block_template_id"===g){p=f.block_template_id;_.isEmpty(p)&&(p=window.tdcAdminSettings.globalBlockTemplate);g=window.tdcAdminSettings.mappedBlockTemplates;for(var h=0;h<g[p].params.length;h++)if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(g[p].params[h].group)||g[p].params[h].group===a)c+=tdcSidebarPanel._bindParamAndGetHtml(g[p].params[h],
b)}else if(0===g.indexOf("tds_")){var k=g.split("-");h=k[0];var l;2===k.length?l=k[1]:2<k.length&&new tdcNotice.notice('Param "'+g+'" must have up to at most one "-" separator ',!0,!1);g=f[g];_.isEmpty(g)&&(g=window.tdcAdminSettings.globalStyle[h]);k=window.tdcAdminSettings.settingsStyle[h];for(h=0;h<k[g].params.length;h++)if(p==a||_.isUndefined(p)&&a===tdcSidebarPanel._defaultGroupName){var m=JSON.parse(JSON.stringify(k[g].params[h]));m.param_name=g+"-"+m.param_name;_.isUndefined(l)||(m.param_name+=
"-"+l);c+=tdcSidebarPanel._bindParamAndGetHtml(m,b)}}}return c},_bindParamAndGetHtml:function(a,d){switch(a.type){case "colorpicker":return tdcSidebarPanel.addColorpicker(a,d);case "gradient":return tdcSidebarPanel.addGradient(a,d);case "dropdown":return tdcSidebarPanel.addDropDown(a,d);case "dropdown-responsive":return tdcSidebarPanel.addDropDownResponsive(a,d);case "checkbox":return tdcSidebarPanel.addCheckBox(a,d);case "checkbox-responsive":return tdcSidebarPanel.addCheckBoxResponsive(a,d);case "range":return tdcSidebarPanel.addRange(a,
d);case "range-responsive":return tdcSidebarPanel.addRangeResponsive(a,d);case "range_multiple":return tdcSidebarPanel.addRangeMultiple(a,d);case "range_multiple-responsive":return tdcSidebarPanel.addRangeMultipleResponsive(a,d);case "icon":return tdcSidebarPanel.addIconSelector(a,d);case "attach_image":return tdcSidebarPanel.addUploadImage(a,d);case "textfield":return tdcSidebarPanel.addTextField(a,d);case "textfield-responsive":return tdcSidebarPanel.addTextFieldResponsive(a,d);case "textarea_html":return tdcSidebarPanel.addTextAreaHtml(a,
d);case "textarea_raw_html":return tdcSidebarPanel.addTextAreaRawHtml(a,d);case "css_editor":return"";case "tdc_css_editor":return tdcCssEditor.init(),tdcCssEditor.addComposerCssEditor(a,d);case "horizontal_separator":return tdcSidebarPanel.addSeparatorHorizontal(a,d);case "text_separator":return tdcSidebarPanel.addTextSeparatorHorizontal(a,d);case "font_header":return tdcSidebarPanel.addFontHeader(a,d);case "font_title":return tdcSidebarPanel.addFontTitle(a,d);case "font_reset":return tdcSidebarPanel.addFontReset(a,
d);case "font_save":return tdcSidebarPanel.addFontSave(a,d);case "font_load":return tdcSidebarPanel.addFontLoad(a,d);case "font_settings":return tdcSidebarPanel.addFontSettings(a,d);case "clearfix":return tdcSidebarPanel.addClearfix(a,d);case "tdc_hidden_field":return"";default:return a.param_name+" - "+a.type+"<br>"}},_deletePanel:function(){tdcSidebarPanel._hook._hooks=[];tdcSidebarPanel._currentBoundModel=h;tdcSidebarPanel.saveTdcPalette();jQuery(".tdc-breadcrumbs").hide();jQuery(".tdc-inspector .tdc-current-element-head").empty();
...
case "Pagination":return"Extra";case "Ajax filter":return"Ajax"}return a},clearPanel:function(){tdcSidebarPanel._deletePanel()},blurInputPanel:function(){jQuery("body").find("input").blur()},_addPresetValuesSelector:function(a,d){var b='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div>'+('<ul class="tdc-preset-values-list" data-model_id="'+d.cid+'">');for(var c=
1;c<a.length;c++){var f="";_.isUndefined(a[c].tdc_preset_individual)||(f='data-individual="1"');var e="";_.isUndefined(a[c].tdc_preset_class)||(e=' class="'+a[c].tdc_preset_class+'"');b+="<li "+f+" "+e+' data-values="'+window.btoa(JSON.stringify(a[c]))+'">'+a[c].tdc_preset_name+"</li>"}b+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return b},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});
jQuery(".tdc-preset-values-list > li").click(function(){var a=jQuery(this),d=a.data("individual"),b=a.parent(".tdc-preset-values-list");a=JSON.parse(window.atob(a.data("values")));var c=tdcIFrameData.getModel(b.data("model_id")),f={};_.isUndefined(d)||(f=_.clone(c.get("attrs")));_.isObject(a)&&(_.map(a,function(a,b){var d=!1;_.map(window.tdcAdminSettings.mappedShortcodes[c.get("tag")].params,function(c,e){c.param_name===b&&(d=!0,f[b]=a)});if(!d){var e=f.block_template_id;_.isUndefined(e)&&(e=window.tdcAdminSettings.globalBlockTemplate);
_.isUndefined(e)||_.map(window.tdcAdminSettings.mappedBlockTemplates[e].params,function(c,e){c.param_name===b&&(d=!0,f[b]=a)})}d||0!==b.indexOf("tds_")||(f[b]=a)}),c.set("attrs",f));tdcSidebarController.onUpdate(c)})},addColorpicker:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property"><div class="tdc-colorpicker-wrap"></div>'+
("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,d)+'"/>');c+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackColorPicker)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackColorPicker);return c},callbackColorPicker:function(){jQuery("#tdc-palette-color-picker").tdPalette();jQuery(".tdc-tab-no-design .tdc-property-colorpicker").each(function(){var a=
jQuery(this),d=a.find("input");a=a.find(".tdc-colorpicker-wrap");_.isUndefined(d.val())||""===d.val()||a.attr("style","background: "+d.val())})},addGradient:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property"><div class="tdc-gradient-wrap tdc-no-gradient-selected"></div>'+("<input "+
tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="hidden" value="'+tdcSidebarPanel._getParameterCurrentValue(a,d)+'"/>');c+="</div></div>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackGradient)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackGradient);return c},callbackGradient:function(){jQuery("#tdc-gradient-color-picker").tdGradient();jQuery(".tdc-property-gradient").each(function(){var a=
jQuery(this),d=a.find("input");a=a.find(".tdc-gradient-wrap");if(!_.isUndefined(d.val())&&""!==d.val())try{var b=JSON.parse(window.atob(d.val()));_.isUndefined(b.css)||a.attr("style",b.css)}catch(c){b=d.val(),_.isUndefined(b)||a.attr("style","background: "+b)}})},addDropDown:function(a,d){var b=!1,c=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&(c=!0);var f="",e="",g=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&
g.length<=parseInt(a.tdc_min_options))return f;for(var h=0;h<g.length;h++){var n=!1,k="",l=g[h],m=String(tdcSidebarPanel._getParameterCurrentValue(a,d)),t=String(a.value[g[h]]);_.isObject(a.value[g[h]])&&(n=!0,t=_.values(a.value[g[h]])[0],l=_.keys(a.value[g[h]])[0]);if(b||c){0===h&&""===m&&(m=t);m===t&&(k=" checked ");m=_.uniqueId();var v=t;if("vc_row"===d.attributes.tag||"vc_row_inner"===d.attributes.tag)v="col_"+v;e+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,
d)+' id="'+m+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+k+' value="'+t+'">';b?(k="",n&&(k="tdc-standard-value"),e+='<label class="tdc-property-input-radio-label '+k+'" for="'+m+'" title="'+l+'"><div class="'+v+'"></div></label>'):e+='<label class="tdc-property-input-radio-label" for="'+m+'" title="'+l+'">'+t+"</label>"}else m===t&&(k=' selected="selected" '),e+="<option "+k+' value="'+t+'">'+l+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');
f+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+g+">"+a.heading+"</span></div>";f+='<div class="tdc-property">';b||c?f+=e:(f+="<select "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'">',f=f+e+"</select>");return f+"</div></div>"},addDropDownResponsive:function(a,d){var b=!1,c=!1;_.has(a,"tdc_dropdown_images")&&""!==a.tdc_dropdown_images&&(b=!0);_.has(a,"tdc_dropdown_texts")&&""!==a.tdc_dropdown_texts&&
(c=!0);var f="",e="",g=Object.keys(a.value);if(_.has(a,"tdc_min_options")&&g.length<=parseInt(a.tdc_min_options))return f;var h=' data-responsive="" ',n=String(tdcSidebarPanel._getParameterCurrentValue(a,d));try{var k=JSON.parse(window.atob(n));h=' data-responsive="'+n+'" ';"undefined"!==typeof k[tdcSidebar.currentViewportSettings.name]&&(n=k[tdcSidebar.currentViewportSettings.name])}catch(r){}for(k=0;k<g.length;k++){var l=!1,m="",t=g[k],v=String(a.value[g[k]]);_.isObject(a.value[g[k]])&&(l=!0,v=
_.values(a.value[g[k]])[0],t=_.keys(a.value[g[k]])[0]);if(b||c){0===k&&""===n&&(n=v);n===v&&(m=" checked ");var u=_.uniqueId(),q=v;if("vc_row"===d.attributes.tag||"vc_row_inner"===d.attributes.tag)q="col_"+q;e+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' id="'+u+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+m+' value="'+v+'">';b?(m="",l&&(m="tdc-standard-value"),e+='<label class="tdc-property-input-radio-label '+m+'" for="'+u+'" title="'+
t+'"><div class="'+q+'"></div></label>'):e+='<label class="tdc-property-input-radio-label" for="'+u+'" title="'+t+'">'+v+"</label>"}else n===v&&(m=' selected="selected" '),e+="<option "+m+' value="'+v+'">'+t+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');f+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+g+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
f+='<div class="tdc-property">';b||c?f+=e:(f+="<select "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+h+g+">",f=f+e+"</select>");return f+"</div></div>"},addCheckBox:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c="";""!==tdcSidebarPanel._getParameterCurrentValue(a,d)&&(c=" checked ");var f='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+
b+">"+a.heading+"</span></div>";f=f+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="checkbox" value="yes" '+c+"/>");return f+"</div></div>"},addCheckBoxResponsive:function(a,d){var b="",c=' data-responsive="" ',f=String(tdcSidebarPanel._getParameterCurrentValue(a,d));try{var e=JSON.parse(window.atob(f));c=' data-responsive="'+f+'" ';"undefined"!==typeof e[tdcSidebar.currentViewportSettings.name]&&(f=e[tdcSidebar.currentViewportSettings.name])}catch(g){}""!==
f&&(b=" checked ");e="";_.has(a,"description")&&""!==a.description&&(e=' title="'+a.description+'" ');f='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+e+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-checkbox" style="display: block;"></div></span></div>';f=f+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+
'" type="checkbox" value="yes" '+b+c+"/>");return f+"</div></div>"},addRange:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c="";_.has(a,"range_max")&&""!==a.range_max&&(c=a.range_max);var f="";_.has(a,"range_min")&&""!==a.range_min&&(f=a.range_min);var e="";_.has(a,"range_step")&&""!==a.range_step&&(e=a.range_step);var g="";_.has(a,"value")&&""!==a.value&&(g=a.value);var h="";""!==tdcSidebarPanel._getParameterCurrentValue(a,d)&&(h=tdcSidebarPanel._getParameterCurrentValue(a,
d));var n='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';n+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";n=n+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+h+'" data-min="'+f+'" data-max="'+c+'" data-step="'+e+'" min="'+f+'" max="'+c+'" step="'+e+'" value="'+h+'" />');return n=n+('<input type="text" class="tdc_range_value" data-default_value="'+
g+'" value="'+h+'"/>')+"</div></div>"},addRangeResponsive:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c="";_.has(a,"range_max")&&""!==a.range_max&&(c=a.range_max);var f="";_.has(a,"range_min")&&""!==a.range_min&&(f=a.range_min);var e="";_.has(a,"range_step")&&""!==a.range_step&&(e=a.range_step);var g="";_.has(a,"value")&&""!==a.value&&(g=a.value);""!==tdcSidebarPanel._getParameterCurrentValue(a,d)&&tdcSidebarPanel._getParameterCurrentValue(a,
d);var h="";_.has(a,"placeholder")&&""!==a.placeholder&&(h=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var n=' data-responsive="" ',k=tdcSidebarPanel._getParameterCurrentValue(a,d);try{var l=JSON.parse(window.atob(k));n=' data-responsive="'+k+'" ';k="undefined"===typeof l[tdcSidebar.currentViewportSettings.name]?"":l[tdcSidebar.currentViewportSettings.name]}catch(m){}l='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';l+='<div class="tdc-property-title"><span'+
b+">"+a.heading+"</span></div>";l=l+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" data-value="'+k+'" data-min="'+f+'" data-max="'+c+'" data-step="'+e+'" min="'+f+'" max="'+c+'" step="'+e+'" value="'+k+'" '+n+" />");return l=l+('<input type="text" class="tdc_range_value" data-default_value="'+g+'" '+h+' value="'+k+'"/>')+"</div></div>"},addRangeMultiple:function(a,d){var b="";_.has(a,"description")&&
""!==a.description&&(b=' title="'+a.description+'" ');var c=a.tdc_values,f=tdcSidebarPanel._getParameterCurrentValue(a,d),e="",g="",h=[],n="",k="",l="",m="",t="",v="",u="",q;for(q in c)c.hasOwnProperty(q)&&(h.push(c[q].unit),""===k||""===n)&&(m=c[q].unit,k=' data-range_unit="'+m+'" ',l=c[q].value,n=' data-range_value="'+l+'" ',t=c[q].range_min,v=c[q].range_max,u=c[q].range_step);if(""!==f){for(var r=[],x=0;x<h.length&&!(r=f.split(h[x]),1<r.length);x++);r.length&&(m=h[x],k=' data-range_unit="'+m+'" ',
l=r[0],n=' data-range_value="'+l+'" ')}for(q in c)c.hasOwnProperty(q)&&(f=_.uniqueId(),e+=" data-value_"+q+'="'+c[q].value+'" ',e+=" data-min_"+q+'="'+c[q].range_min+'" ',e+=" data-max_"+q+'="'+c[q].range_max+'" ',e+=" data-step_"+q+'="'+c[q].range_step+'" ',h=c[q].value,r="",c[q].unit===m&&(h=l,t=c[q].range_min,v=c[q].range_max,u=c[q].range_step,r="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+q+'" data-unit_value="'+c[q].unit+'" type="radio" id="'+f+'" '+
r+' data-default_value="'+c[q].value+'" data-last_value="'+h+'"/>',g+='<label for="'+f+'">'+c[q].unit+"</label>");c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+n+" "+k+" "+e+' min="'+t+'" max="'+v+'" step="'+u+'" value="'+l+'"/>');
c=c+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+"</div>"+('<input type="text" class="tdc_range_value" value="'+l+'"/>');c+="</div>";c+="</div>";return c+="</div>"},addRangeMultipleResponsive:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c=a.tdc_values,f=tdcSidebarPanel._getParameterCurrentValue(a,d),e="",g="",h=[],n=' data-responsive="" ',k="",l="",m="",t="",v="",u="",q="",r;for(r in c)c.hasOwnProperty(r)&&
(h.push(c[r].unit),""===l||""===k)&&(t=c[r].unit,l=' data-range_unit="'+t+'" ',m=c[r].value,k=' data-range_value="'+m+'" ',v=c[r].range_min,u=c[r].range_max,q=c[r].range_step);if(""!==f){var x=f;try{var z=JSON.parse(window.atob(f));n=' data-responsive="'+f+'" ';x="undefined"===typeof z[tdcSidebar.currentViewportSettings.name]?"":z[tdcSidebar.currentViewportSettings.name]}catch(w){}if(""!==x){f=[];for(z=0;z<h.length&&!(f=x.split(h[z]),1<f.length);z++);f.length&&(t=h[z],l=' data-range_unit="'+t+'" ',
m=f[0],k=' data-range_value="'+m+'" ')}}for(r in c)c.hasOwnProperty(r)&&(h=_.uniqueId(),e+=" data-value_"+r+'="'+c[r].value+'" ',e+=" data-min_"+r+'="'+c[r].range_min+'" ',e+=" data-max_"+r+'="'+c[r].range_max+'" ',e+=" data-step_"+r+'="'+c[r].range_step+'" ',x=c[r].value,f="",c[r].unit===t&&(x=m,v=c[r].range_min,u=c[r].range_max,q=c[r].range_step,f="checked"),g+='<input name="'+tdcSidebarPanel._getParameterDomName(a)+'_unit" data-unit="'+r+'" data-unit_value="'+c[r].unit+'" type="radio" id="'+h+
'" '+f+' data-default_value="'+c[r].value+'" data-last_value="'+x+'"/>',g+='<label for="'+h+'">'+c[r].unit+"</label>");c='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+('<input class="tdc-multiple-range" '+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="range" '+k+" "+l+" "+e+" "+n+' min="'+v+'" max="'+
u+'" step="'+q+'" value="'+m+'"/>');c=c+'<div class="tdc-multiple-range-wrap"><div class="tdc-multiple-range-value">'+g+"</div>"+('<input type="text" class="tdc_range_value" value="'+m+'"/>');c+="</div>";c+="</div>";return c+="</div>"},addIconSelector:function(a,d){var b="";_.has(a,"description")&&""!==a.description&&(b=' title="'+a.description+'" ');var c='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';c+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";c=c+'<div class="tdc-property">'+
...
window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:f,action:"tdc_ajax_get_image_url"}}).done(function(a,b,c){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(e.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),e.data("image_link",a.image_url),e.data("image_id",f),e.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,b,c){})}})});return c},addTextField:function(a,
d){var b="",c="";if(_.has(a,"description")&&""!==a.description){var f=jQuery("<div>"+a.description+"</div>");a.description===f.text()?b=' title="'+a.description+'" ':c='<div class="tdc-description">'+a.description+"</div>"}f="";_.has(a,"placeholder")&&""!==a.placeholder&&(f=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var e='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';e+='<div class="tdc-property-title"><span'+b+">"+a.heading+"</span></div>";e=e+'<div class="tdc-property">'+
("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" '+f+' value="'+tdcSidebarPanel._getParameterCurrentValue(a,d)+'"/>');return e=e+c+"</div></div>"},addTextFieldResponsive:function(a,d){var b="",c="";if(_.has(a,"description")&&""!==a.description){var f=jQuery("<div>"+a.description+"</div>");a.description===f.text()?b=' title="'+a.description+'" ':c='<div class="tdc-description">'+a.description+"</div>"}f="";_.has(a,"placeholder")&&
""!==a.placeholder&&(f=' data-placeholder="'+a.placeholder+'" placeholder="'+a.placeholder+'" ');var e=' data-responsive="" ',g=tdcSidebarPanel._getParameterCurrentValue(a,d);try{var h=JSON.parse(window.atob(g));e=' data-responsive="'+g+'" ';g="undefined"===typeof h[tdcSidebar.currentViewportSettings.name]?"":h[tdcSidebar.currentViewportSettings.name]}catch(n){}h='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';h+='<div class="tdc-property-title"><span'+b+">"+a.heading+
"</span></div>";h=h+'<div class="tdc-property">'+("<input "+tdcSidebarPanel._getParamterDataAtts(a,d)+' name="'+tdcSidebarPanel._getParameterDomName(a)+'" type="text" value="'+g+'" '+f+e+b+"/>");return h=h+c+"</div></div>"},addTextAreaHtml:function(a,d){_.has(a,"description");return'<a href="#" class="tdc-open-wpeditor" data-model_id="'+d.cid+'" data-mapped_parameter_name="'+a.param_name+'">Edit Content</a>'},addTextAreaRawHtml:function(a,d){var b=_.uniqueId("tdc_textarea_"),c="";_.has(a,"description")&&
""!==a.description&&(c=' title="'+a.description+'" ');var f='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';f+='<div class="tdc-property-title"><span'+c+">"+a.heading+"</span></div>";f=f+'<div class="tdc-property">'+('<textarea id="'+b+'" class="tdc-textarea" '+tdcSidebarPanel._getParamterDataAtts(a,d)+">"+tdcSidebarPanel._getParameterCurrentValue(a,d)+"</textarea>");f+="</div></div>";jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/decode_html_content","uuid="+
tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{post_id:window.tdcPostSettings.postId,action:"tdc_ajax_decode_html_content",content:tdcSidebarPanel._getParameterCurrentValue(a,d)}}).done(function(a,c,d){"success"===c&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):jQuery("#"+b).html(a.parsed_content).addClass("tdc-textarea-visible"))}).fail(function(a,b,c){});jQuery("body").on("keyup",
"#"+b,function(a){a=jQuery(a.target);var b=tdcIFrameData.getModel(a.data("model_id")),c=window.btoa(encodeURIComponent(a.val()));tdcSidebarController.onUpdate(b,a.data("param_name"),c,c)});return f},addSeparatorHorizontal:function(a,d){return'<div class="tdc-sidebar-horizontal-separator '+tdcSidebarPanel._getParameterClasses(a)+'"></div>'},addTextSeparatorHorizontal:function(a,d){return'<div class="tdc-sidebar-text-separator tdc-property-title '+tdcSidebarPanel._getParameterClasses(a)+'"><span>'+
a.heading+"</span></div>"},addFontHeader:function(a,d){return'<div class="tdc-sidebar-font-header '+tdcSidebarPanel._getParameterClasses(a)+'"><span class="tdc-font-ico1" title="Font size"></span><span class="tdc-font-ico2" title="Line height (Use with px or a number that will be multiplied with the current font-size)"></span><span class="tdc-font-ico3" title="Font style"></span><span class="tdc-font-ico4" title="Font weight"></span><span class="tdc-font-ico5" title="Text transform"></span><span class="tdc-font-ico6" title="Letter spacing"></span></div>'},
...
"selected"):(a.val(d),b.addClass("tdc-css-inherited")),c.hide()):(a.val(d),b.removeClass("tdc-css-inherited"),"all"===tdcSidebar.currentViewportSettings.name?c.hide():c.show());else if(b.hasClass("tdc-property-range-responsive")){c="";_.isUndefined(a.data("placeholder"))||(c=a.data("placeholder"));var f=a.next('input[type="text"]');f.attr("placeholder",c);_.isUndefined(d)?(d=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(d)?(a.val(""),f.val("")):(a.val(d),f.val(d),f.attr("placeholder",
d),b.addClass("tdc-css-inherited"))):(a.val(d),f.val(d),b.removeClass("tdc-css-inherited"))}else if(b.hasClass("tdc-property-range_multiple-responsive")){c=tdcIFrameData.getModel(a.data("model_id"));var e=a.data("param_name"),g=window.tdcAdminSettings.mappedShortcodes[c.attributes.tag];c=[];for(var h=f="",n=0;n<g.params.length;n++)if(e===g.params[n].param_name){e=g.params[n].tdc_values;for(var k in e)e.hasOwnProperty(k)&&(c.push(e[k].unit),""===f||""===h)&&(f=e[k].value,h=e[k].unit);break}_.isUndefined(d)?
(d=tdcSidebarPanel.getCurrentResponsiveValue(a.attr("name"),"all"),_.isUndefined(d)&&(a.data("range_value",f),a.data("range_unit",h),a.val(f),k=b.find('input[type="radio"][data-unit_value="'+h+'"]'),n=k.data("unit"),e=a.data("min_"+n),h=a.data("max_"+n),n=a.data("step_"+n),g=a.get(0),k.prop("checked",!0),g.min=e,g.max=h,g.step=n,g.value=f,k.data("last_value",f),b.find('input[type="text"]').val(f)),"all"===tdcSidebar.currentViewportSettings.name?b.removeClass("tdc-css-inherited"):b.addClass("tdc-css-inherited")):
b.removeClass("tdc-css-inherited");if(!_.isUndefined(d)){f=[];for(n=0;n<c.length&&!(f=d.split(c[n]),1<f.length);n++);f.length&&(f=f[0],h=c[n],a.data("range_value",f),a.data("range_unit",h),a.val(f),k=b.find('input[type="radio"][data-unit_value="'+h+'"]'),n=k.data("unit"),e=a.data("min_"+n),h=a.data("max_"+n),n=a.data("step_"+n),g=a.get(0),k.prop("checked",!0),g.min=e,g.max=h,g.step=n,g.value=f,k.data("last_value",f),b.find('input[type="text"]').val(f))}}}}})();var tdcUtil={};
