...
$td_cloud_cat_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/cat_cloud_template.txt',
...
$td_cloud_post_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/post_cloud_template.txt',
...
$td_cloud_global_author_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/author_cloud_template.txt',
...
$td_cloud_global_404_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/404_cloud_template.txt',
    'template_type' => '404',
));
...
$td_cloud_global_search_template_id = td_demo_content::add_cloud_template(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/search_cloud_template.txt',
...
$td_homepage_id = td_demo_content::add_page(array(
    'title' => 'Home',
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/homepage.txt',
...
$td_footerpage_id = td_demo_content::add_page(array(
    'title' => 'Footer',
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/footer.txt',
    'template' => 'default',   // the page template full file name with .php, for default no extension needed
    'td_layout' => '',
...
td_demo_content::add_post(array(
    ...
    'file' => td_global::$get_template_directory . '/includes/demos/fast/pages/post_default.txt',
